...
//For model
float hombro, codo, mano, dedo, falange = 0.0f;
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Dedo 1
		model = glm::translate(modelTemp2, glm::vec3(0.3f, 0.25f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = glm::rotate(model, glm::radians(falange), glm::vec3(0.0f, 1.0f, 0.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.6f, 0.2f, 0.2f));
		...
		// Dedo 2
		model = glm::translate(modelTemp2, glm::vec3(0.3f, 0.00f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo), glm::vec3(0.0f, 1.0f, 0.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.6f, 0.2f, 0.2f));
		color = glm::vec3(1.0f, 1.0f, 1.0f);
