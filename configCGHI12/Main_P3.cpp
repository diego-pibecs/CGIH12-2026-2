...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLint modelLoc2 = glGetUniformLocation(ourShader.Program, "model");
		...
		model = glm::rotate(model, 1.0f, glm::vec3(1.0f, 0.5f, 0.3f));
		...
		model = glm::rotate(model, 1.0f, glm::vec3(0.5f, 0.5f, 0.8f));
