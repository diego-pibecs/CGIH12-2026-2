...
int main() {
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Draw three cubes: base + two extra variants with different shapes.
		ourShader.Use();
		...
		model = glm::rotate(model, 4.0f, glm::vec3(1.0f, 0.5f, 0.3f));
		...
		model = glm::rotate(model, 1.0f, glm::vec3(1.5f, 2.5f, 0.0f));
