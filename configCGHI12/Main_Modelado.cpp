...
void dibujar(GLint modelLoc, glm::mat4 modelo, GLuint VAO);
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		float transformaciones[] = {
			// traslacion         / escalado
			 0.0f,  0.75f,  0.0f, 2.5f, 0.05f, 2.5f,
			 1.0f,   0.0f,  1.0f, 0.1f,  1.5f, 0.1f,
			 1.0f,   0.0f, -1.0f, 0.1f,  1.5f, 0.1f,
			-1.0f,   0.0f, -1.0f, 0.1f,  1.5f, 0.1f,
			-1.0f,   0.0f,  1.0f, 0.1f,  1.5f, 0.1f,
		};
		...
		/* Tabla
		trasladarEscalar(model, modelLoc, VAO, 0.0f, 0.75f, 0.0f, 2.5f, 0.05f, 2.5f);
 ...
 void transformarPrisma(glm::mat4 modelo, int transformacion, float x, float y, float z) {
	 modelo = glm::mat4(1.0f);
	 if (transformacion == 0) // traslacion
	 {
		 modelo = glm::translate(modelo, glm::vec3(x, y, z));
	 }
	 else if (transformacion == 1) // rotacion
	 {
		 modelo = glm::rotate(modelo, glm::radians(0.5f), glm::vec3(x, y, z));
	 }
 }
